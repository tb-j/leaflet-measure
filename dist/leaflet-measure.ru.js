!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Измерение расстояний и площади">Измерениеss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Измерение расстояний и площади <ul class=tasks> <a href=# class="js-start start">Создать новое измерение</a> </ul> </div> <div class=js-measuringprompt> Измерение расстояний и площади <p class=js-starthelp>Для начала измерения добавьте точку на карту</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Отменить</a></li> <li><a href=# class="js-finish finish">Закончить измерение</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Последняя точка</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
