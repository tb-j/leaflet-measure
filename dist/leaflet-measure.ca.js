!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Medeix distancies i àreas">Medirss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Medeix distancies i àreas <ul class=tasks> <a href=# class="js-start start">Crear nova medicio</a> </ul> </div> <div class=js-measuringprompt> Medeix distancies i àreas <p class=js-starthelp>Començi a crear la medicio afegint punts al mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancel·lar</a></li> <li><a href=# class="js-finish finish">Acabar la medició</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Últim punt</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
