!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Măsurarea distanțelor și a suprafețelor">Măsuraress</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Măsurarea distanțelor și a suprafețelor <ul class=tasks> <a href=# class="js-start start">Efectuează o măsurare nouă</a> </ul> </div> <div class=js-measuringprompt> Măsurarea distanțelor și a suprafețelor <p class=js-starthelp>Efectuează o măsurare nouă alegând noi puncte pe hartă</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Oprește</a></li> <li><a href=# class="js-finish finish">Opreste măsurarea</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Ultimul punct</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
