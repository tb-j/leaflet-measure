!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Távolság- és területmérések">Mérésss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Távolság- és területmérések <ul class=tasks> <a href=# class="js-start start">Egy új mérés elvégzése</a> </ul> </div> <div class=js-measuringprompt> Távolság- és területmérések <p class=js-starthelp>Végezzen mérést pontok elhelyezésével a térképen.</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Mégse</a></li> <li><a href=# class="js-finish finish">Mérés befejezése</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Utolsó pont</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
