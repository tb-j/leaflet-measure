!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mål afstande og arealer">Målss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Mål afstande og arealer <ul class=tasks> <a href=# class="js-start start">Lav en ny måling</a> </ul> </div> <div class=js-measuringprompt> Mål afstande og arealer <p class=js-starthelp>Begynd målingen ved at tilføje punkter på kortet</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Annuller</a></li> <li><a href=# class="js-finish finish">Afslut måling</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Sidste punkt</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
