!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Medir distâncias e áreas">Mediçõesss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Medir distâncias e áreas <ul class=tasks> <a href=# class="js-start start">Criar uma nova medição</a> </ul> </div> <div class=js-measuringprompt> Medir distâncias e áreas <p class=js-starthelp>Adicione pontos no mapa, para criar uma nova medição</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medição</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Último ponto</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
