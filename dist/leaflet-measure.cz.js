!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="měření vzdáleností a výměr">Měřeníss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> měření vzdáleností a výměr <ul class=tasks> <a href=# class="js-start start">provést nové měření</a> </ul> </div> <div class=js-measuringprompt> měření vzdáleností a výměr <p class=js-starthelp>proveďte měření přidáním bodů do mapy</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">zrušit</a></li> <li><a href=# class="js-finish finish">ukončit měření</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>poslední bod</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
