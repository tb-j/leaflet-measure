!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Messung von Abständen und Flächen">Messungss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Messung von Abständen und Flächen <ul class=tasks> <a href=# class="js-start start">Eine neue Messung durchführen</a> </ul> </div> <div class=js-measuringprompt> Messung von Abständen und Flächen <p class=js-starthelp>Führen Sie die Messung durch, indem Sie der Karte Punkte hinzufügen.</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Abbrechen</a></li> <li><a href=# class="js-finish finish">Messung beenden</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
