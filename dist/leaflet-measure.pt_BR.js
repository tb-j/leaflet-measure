!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      ' <span class=result-wrapper> <div class=startprompt> <div class="d-flex justify-content-between"> <div class="col leaflet-control-measure fw-500"> Medida linear </div> </div> </div> <p>{{ model.lengthDisplay }}</p> <div class="js-finish mt-3 d-flex align-items-center justify-content-center"> <button class="js-deletemarkup btn btn-outline-secondary btn-sm d-flex align-items-center" type=button><i class="fa-sm fa-regular fa-trash-can pe-2"></i> Excluir </button> </div> </span>';
  },
  function(e, t, r) {
    e.exports =
      '<span class=result-wrapper> <div class=startprompt> <div class="d-flex justify-content-between"> <div class="col leaflet-control-measure fw-500"> Medida de área </div> </div> </div> <p> Distância </p> <p class=m-0> {{ model.areaDisplay }} </p> <p class=mt-2> Área </p> <p class=m-0> {{ model.lengthDisplay }} Perímetro </p> <div class="js-finish mt-3 d-flex align-items-center justify-content-center"> <button class="js-deletemarkup btn btn-outline-secondary btn-sm" type=button><i class="fa-sm fa-regular fa-trash-can pe-2"></i> Excluir </button> </div> </span>';
  }
]);
