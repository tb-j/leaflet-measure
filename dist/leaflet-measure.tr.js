!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Uzaklık ve alan hesapla">Hesaplass</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Uzaklık ve alan hesapla <ul class=tasks> <a href=# class="js-start start">Yeni hesaplama</a> </ul> </div> <div class=js-measuringprompt> Uzaklık ve alan hesapla <p class=js-starthelp>Yeni nokta ekleyerek hesaplamaya başla</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Çıkış</a></li> <li><a href=# class="js-finish finish">Hesaplamayı bitir</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Son nokta</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
