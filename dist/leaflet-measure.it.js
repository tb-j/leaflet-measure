!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Misura distanze e aree">Misurass</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Misura distanze e aree <ul class=tasks> <a href=# class="js-start start">Crea una nuova misurazione</a> </ul> </div> <div class=js-measuringprompt> Misura distanze e aree <p class=js-starthelp>Comincia a creare una misurazione aggiungendo punti alla mappa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Annulla</a></li> <li><a href=# class="js-finish finish">Misurazione conclusa</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Ultimo punto</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
