!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Meet afstanden en oppervlakten">Meetss</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Meet afstanden en oppervlakten <ul class=tasks> <a href=# class="js-start start">Maak een nieuwe meting</a> </ul> </div> <div class=js-measuringprompt> Meet afstanden en oppervlakten <p class=js-starthelp>Begin een meting door punten toe te voegen aan de kaart</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Annuleer</a></li> <li><a href=# class="js-finish finish">Beëindig meting</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Laatste punt</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
