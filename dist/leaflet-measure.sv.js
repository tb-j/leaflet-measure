!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mäta avstånd och yta">Mätass</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Mäta avstånd och yta <ul class=tasks> <a href=# class="js-start start">Skapa ny mätning</a> </ul> </div> <div class=js-measuringprompt> Mäta avstånd och yta <p class=js-starthelp>Börja mätning genom att lägga till punkter på kartan</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Avbryt</a></li> <li><a href=# class="js-finish finish">Avsluta mätning</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Sista punkt</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
