!(function(t) {
      ...
      s(t, function(t, r, o) {
        ...
        if (t.geometry) {
          ...
          if ('Point' !== s && 'MultiPoint' !== s) {
            ...
            return (
              !1 !==
                n(t, function(n, s, u, c, f) {
                  if (void 0 === a) return void (a = n);
                  var p = Object(l.e)([a, n], t.properties);
  ...
  function(t, e, r) {
    t.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mäta avstånd och yta">Mäta</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <div class="d-flex justify-content-between pb-2"> <div class="col fw-500"> Mäta avstånd och yta </div> <div></div> </div> <div class="js-start mt-1 d-flex align-items-center justify-content-center"> <button class="btn btn-outline-secondary btn-sm" type=button><i class="fa-regular fa-sm fa-circle-play pe-2"></i> Skapa ny mätning </button> </div> </div> <div class=js-measuringprompt> <div class="d-flex justify-content-between"> <div class="col fw-500"> Mäta avstånd och yta </div> <div> <span class=js-measuretasks> <button class="js-cancel btn btn-close btn-close-min"></button> </span> </div> </div> <p class=js-starthelp>Börja mätning genom att lägga till punkter på kartan</p> <div class="js-results results"></div> <span class="js-measuretasks tasks mt-0"> <div class="js-finish mt-3 d-flex align-items-center justify-content-center"> <button class="btn btn-outline-secondary btn-sm" type=button><i class="fa-sm fa-regular fa-circle-stop pe-2"></i>Avsluta mätning</button> </div> </span> </div> </div>';
  },
  function(t, e, r) {
    t.exports =
      '<div> <p class=mt-3>Sista punkt</p> <p class=m-0>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p class=m-0>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <% if (model.pointCount> 1) { %> <p class=mt-3> Total linjelängd </p> <p class=mt-0> {{ model.lengthDisplay }} </p> <% } %> <% if (model.pointCount> 2) { %> <p class=mt-3>Yta</p> <p class=m-0> {{ model.areaDisplay }}</p> <% } %> </div> ';
  },
  function(t, e, r) {
    t.exports =
  ...
  function(t, e, r) {
    t.exports =
      '<span class=result-wrapper> <div class=startprompt> <div class="d-flex justify-content-between"> <div class="col leaflet-control-measure fw-500"> Arealmätning </div> </div> </div> <p> Total linjelängd </p> <p class=m-0> {{ model.areaDisplay }} </p> <p class=mt-2> Yta </p> <p class=m-0> {{ model.lengthDisplay }} Omkrets </p> <div class="js-finish mt-3 d-flex align-items-center justify-content-center"> <button class="js-deletemarkup btn btn-outline-secondary btn-sm" type=button><i class="fa-sm fa-regular fa-trash-can pe-2"></i> Radera </button> </div> </span>';
  }
]);
