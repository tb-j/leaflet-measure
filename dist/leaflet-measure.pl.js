!(function(e) {
            ...
            if (null !== (a = p ? c.geometries[b] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(l, d, g, _, w)) return !1;
                  d++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (o = 0; o < l.length; o++) {
                    if (!1 === t(l[o], d, g, _, w)) return !1;
                    d++, 'MultiPoint' === j && _++;
                  }
                  'LineString' === j && _++;
                  break;
                ...
                case 'MultiPolygon':
                  for (o = 0; o < l.length; o++) {
                    for ('MultiPolygon' === j && (w = 0), i = 0; i < l[o].length; i++) {
                      for (s = 0; s < l[o][i].length - f; s++) {
                        if (!1 === t(l[o][i][s], d, g, _, w)) return !1;
                        d++;
                      }
                      w++;
                    }
      ...
      for (r = 0; r < m; r++) {
        for (
          a = d ? e.features[r].geometry : h ? e.geometry : e,
            ...
            p = d ? e.features[r].id : h ? e.id : void 0,
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Narzędzia pomiarowe">Pomiar</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <div class="d-flex justify-content-between pb-2"> <div class="col fw-500"> Narzędzia pomiarowe </div> <div></div> </div> <div class="js-start mt-1 d-flex align-items-center justify-content-center"> <button class="btn btn-outline-secondary btn-sm" type=button><i class="fa-regular fa-sm fa-circle-play pe-2"></i> Nowy pomiar </button> </div> </div> <div class=js-measuringprompt> <div class="d-flex justify-content-between"> <div class="col fw-500"> Narzędzia pomiarowe </div> <div> <span class=js-measuretasks> <button class="js-cancel btn btn-close btn-close-min"></button> </span> </div> </div> <p class=js-starthelp>Rozpocznij tworzenie nowego pomiaru poprzez dodanie punktów na mapie</p> <div class="js-results results"></div> <span class="js-measuretasks tasks mt-0"> <div class="js-finish mt-3 d-flex align-items-center justify-content-center"> <button class="btn btn-outline-secondary btn-sm" type=button><i class="fa-sm fa-regular fa-circle-stop pe-2"></i>Zakończ</button> </div> </span> </div> </div>';
  },
  function(e, t, r) {
    e.exports =
      '<div> <p class=mt-3>Ostatni punkt</p> <p class=m-0>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p class=m-0>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <% if (model.pointCount> 1) { %> <p class=mt-3> Długość </p> <p class=mt-0> {{ model.lengthDisplay }} </p> <% } %> <% if (model.pointCount> 2) { %> <p class=mt-3>Powierzchnia</p> <p class=m-0> {{ model.areaDisplay }}</p> <% } %> </div> ';
  },
  function(e, t, r) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      ' <span class=result-wrapper> <div class=startprompt> <div class="d-flex justify-content-between"> <div class="col leaflet-control-measure fw-500"> Pomiar liniowy </div> </div> </div> <p>{{ model.lengthDisplay }}</p> <div class="js-finish mt-3 d-flex align-items-center justify-content-center"> <button class="js-deletemarkup btn btn-outline-secondary btn-sm" type=button><i class="fa-sm fa-regular fa-trash-can pe-2"></i> Skasuj </button> </div> </span>';
  },
  function(e, t, r) {
    e.exports =
      '<span class=result-wrapper> <div class=startprompt> <div class="d-flex justify-content-between"> <div class="col leaflet-control-measure fw-500"> Pomiar powierzchni </div> </div> </div> <p> Długość </p> <p class=m-0> {{ model.areaDisplay }} </p> <p class=mt-2> Powierzchnia </p> <p class=m-0> {{ model.lengthDisplay }} Obwód </p> <div class="js-finish mt-3 d-flex align-items-center justify-content-center"> <button class="js-deletemarkup btn btn-outline-secondary btn-sm" type=button><i class="fa-sm fa-regular fa-trash-can pe-2"></i> Skasuj </button> </div> </span>';
  }
]);
