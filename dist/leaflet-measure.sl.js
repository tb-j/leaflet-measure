!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Meritve razdalj in površin">Meritvess</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> Meritve razdalj in površin <ul class=tasks> <a href=# class="js-start start">Napravi novo meritev</a> </ul> </div> <div class=js-measuringprompt> Meritve razdalj in površin <p class=js-starthelp>Izvedi meritev z vstavljanjem točk v zemljevid</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Prekliči</a></li> <li><a href=# class="js-finish finish">Končaj meritev</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=d-flex> <div>Zadnja točka</div> <div>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</div> <div>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</div> </div> ';
  },
  function(e, t, r) {
    e.exports =
